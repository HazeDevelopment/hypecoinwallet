...
const char COMMUNITY_FORUM_URL[] = "http://gethypecoin.org";
const char REPORT_ISSUE_URL[] = "http://gethypecoin.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("HypeCoin Wallet %1").arg(Settings::instance().getVersion()));
