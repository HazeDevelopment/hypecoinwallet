...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/hypecoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutHypeCoinAction = new QAction(MainWindow);
        m_aboutHypeCoinAction->setObjectName(QStringLiteral("m_aboutHypeCoinAction"));
        m_aboutHypeCoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutHypeCoinAction);
        ...
        QObject::connect(m_aboutHypeCoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutHypeCoinAction->setText(QApplication::translate("MainWindow", "About HypeCoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND HYPE", 0));
